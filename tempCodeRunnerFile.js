...
initalizePassport(passport, email => users.find(user =>user.email === email), id =>users.find(user =>user.id === id))
...
app.post('/signup', checkNotAuthenticated, async(req,res) => {
    try {
        ...
        users.push({
            id:Date.now().toString(),                  //database will do this can delete later
            name: req.body.name,
